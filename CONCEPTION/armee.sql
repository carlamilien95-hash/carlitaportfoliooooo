...
--
-- Hôte : localhost
-- Généré le : mar. 03 fév. 2026 à 09:41
...
--
ALTER TABLE `affecte`
  ADD PRIMARY KEY (`code_unite`,`code_soldat`),
  ADD KEY `code_soldat` (`code_soldat`);
...
ALTER TABLE `blesse`
  ...
  ADD KEY `code_bataille` (`code_bataille`),
  ADD KEY `code_blessure` (`code_blessure`);
...
--
ALTER TABLE `promu`
  ADD PRIMARY KEY (`code_grade`,`code_soldat`),
  ADD KEY `code_soldat` (`code_soldat`);
...
--
ALTER TABLE `affecte`
  ADD CONSTRAINT `affecte_ibfk_1` FOREIGN KEY (`code_unite`) REFERENCES `unites` (`code_unite`),
  ADD CONSTRAINT `affecte_ibfk_2` FOREIGN KEY (`code_soldat`) REFERENCES `soldats` (`code_soldat`);

--
-- Contraintes pour la table `blesse`
--
ALTER TABLE `blesse`
  ADD CONSTRAINT `blesse_ibfk_1` FOREIGN KEY (`code_soldat`) REFERENCES `soldats` (`code_soldat`),
  ADD CONSTRAINT `blesse_ibfk_2` FOREIGN KEY (`code_bataille`) REFERENCES `batailles` (`code_bataille`),
  ADD CONSTRAINT `blesse_ibfk_3` FOREIGN KEY (`code_blessure`) REFERENCES `blessures` (`code_blessure`);

--
-- Contraintes pour la table `promu`
--
ALTER TABLE `promu`
  ADD CONSTRAINT `promu_ibfk_1` FOREIGN KEY (`code_grade`) REFERENCES `grade` (`code_grade`),
  ADD CONSTRAINT `promu_ibfk_2` FOREIGN KEY (`code_soldat`) REFERENCES `soldats` (`code_soldat`);
COMMIT;
